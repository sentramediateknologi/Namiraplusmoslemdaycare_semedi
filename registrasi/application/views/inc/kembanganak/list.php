                                ...
                                <div class="modal-body">                                   
                                    <fieldset>
                                        <div class="form-group">
                                            <label>Aspek</label>
                                            <select class="form-control" required name="id_aspek">
                                                <?php foreach ($aspek as $key => $d): ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <fieldset>
                                        <div class="form-group">
                                            <label>Aspek</label>
                                            <select class="form-control" required name="id_aspek" id="id_aspek">
                                                <?php foreach ($aspek as $key => $d): ?>
                                                    <option value="<?= $d->id ?>" > <?= $d->name ?> </option>
                                                <?php endforeach ?>
                                            </select>
        ...
        $('.edit').click(function(){
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#id_aspek").val(data['list_edit']['id_aspek']);                                    
