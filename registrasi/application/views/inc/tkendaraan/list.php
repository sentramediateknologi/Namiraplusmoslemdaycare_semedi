                                ...
                                <div class="modal-body">                                                                  
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required name="id_kendaraan">
                                        ...
                                        <div class="form-group">
                                            <label>Catatan</label>
                                            <textarea class="form-control" type="text" name="catatan" required> </textarea>
                                        </div>
                                    </fieldset>                                                                
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <fieldset>
                                        <div class="form-group">
                                            <label>Kendaraan</label>
                                            <select class="form-control" required name="id_kendaraan" id="id_kendaraan">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>Tanggal Mulai</label>
                                                    <input class="form-control" type="text" id="tanggal_peminjaman_mulai" disabled="true">
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Tanggal Selesai</label>
                                        ...
                                        <div class="form-group">
                                            <label>Tujuan</label>
                                            <input class="form-control" type="text" name="tujuan" required id="tujuan">
                                        </div>
                                        <div class="form-group">
                                            <label>Keperluan</label>
                                        ...
                                        <div class="form-group">
                                            <label>Catatan</label>
                                            <textarea class="form-control" type="text" name="catatan" required id="catatan"> </textarea>
                                        </div>
        ...
        $('.detail').click(function(){
            $.ajax({
                ...
                success: function(data){
                    ...
                    $(".detail-catatan").text(data['list_edit']['catatan']);  
