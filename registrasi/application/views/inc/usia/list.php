                                ...
                                <div class="modal-body">                                   
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" required name="name" placeholder="0-3 Bulan">
                                        </div>
                                    </fieldset>                                    
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <fieldset>
                                        <div class="form-group">
                                            <label>Nama <?= $title ?></label>
                                            <input class="form-control" type="text" required name="name" id="name" placeholder="0-3 Bulan">
                                        </div>
