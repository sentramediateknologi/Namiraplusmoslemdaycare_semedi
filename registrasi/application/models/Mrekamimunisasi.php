<?php  
	...
	class MRekamimunisasi extends CI_Model
	{
		public function __construct() {
			parent::__construct();

	        ## declate table name here
	        $this->table_name = 'registrasi_data_rekam_medik_imunisasi' ;
	    }
	    ...
	    function getListbyIdrekam($idrekam) {
            
            $this->db->where(array('is_active' => '1','id_rekam_medik' => $idrekam));
		...
		function delete($id) {
			...
			$this->db->where('id_rekam_medik', $id);
